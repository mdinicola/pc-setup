...
if (Test-Path -Path "$destinationConfigFile" -PathType Leaf) {
    Write-Information "Mise config file already exists.  Skipping configuration"
}
else {
    Write-Information "Writing mise config file to $destinationConfigFile"
...
Write-Information "Installing mise applications and tools"
